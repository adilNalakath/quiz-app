        ...
        children: [
          ...
          Center(
            child: Container(
              ...
              child: Center(
                child: Text(historyquestions[index].question!,
          ...
          GestureDetector(
            onTap: () {
              setState(() {
                if (historyquestions[index].indexOfAnswer == 0) {
                  mark++;
                } 
          ...
          GestureDetector(
            onTap: () {
              setState(() {
                if (historyquestions[index].indexOfAnswer == 1) {
                  mark++;
                } 
                print(mark);
                print('mark');
          ...
          GestureDetector(
            onTap: () {
              setState(() {
                if (historyquestions[index].indexOfAnswer == 2) {
                  mark++;
                }
          ...
          GestureDetector(
            onTap: () {
              setState(() {
                if (historyquestions[index].indexOfAnswer == 3) {
                  mark++;
                }
